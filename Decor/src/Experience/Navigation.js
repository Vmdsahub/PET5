...
export default class Navigation
{
    ...
    setView()
    {
        ...
        this.view.spherical = {}
        this.view.spherical.value = new THREE.Spherical(25, Math.PI * 0.3, - Math.PI * 0.15)
        ...
        this.view.spherical.limits.radius = { min: 3, max: 60 }
        this.view.spherical.limits.phi = { min: 0.01, max: Math.PI * 0.5 }
        this.view.spherical.limits.theta = { min: - Math.PI * 0.8, max: Math.PI * 0.8 }

        this.view.target = {}
        this.view.target.value = new THREE.Vector3(0, 3, 0)
